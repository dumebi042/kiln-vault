...
interface ISanctionsList {
    ...
    /// @notice Remove addresses from the internal sanctions list.
    /// @param sanctions The addresses to remove.
    function removeFromSanctionsList(address[] memory sanctions) external;
}
...
/// @author maximebrugel @ Kiln.
interface IFeeDispatcher_1_0_0 {
...
} from "./Errors_1_0_0.sol";
import {IFeeDispatcher_1_0_0} from "./IFeeDispatcher_1_0_0.sol";

/// @title FeeDispatcher.
/// @notice Dispatches the pending management and performance fees to the fee recipients.
/// @dev Using ERC-7201 standard.
/// @author maximebrugel @ Kiln.
abstract contract FeeDispatcher_1_0_0 is Initializable, IFeeDispatcher_1_0_0 {
    using SafeERC20 for IERC20;
    using Math for uint256;
    ...
    /// @inheritdoc IFeeDispatcher_1_0_0
